        ...
        http
                ...
                .authorizeRequests((authorizeRequests) ->
                        authorizeRequests
                                ...
                                .antMatchers("/api/v1/count/user").permitAll()
                                .antMatchers("/api/v1/count/school").permitAll()
                                .antMatchers("/api/v1/count/schoolguestbook").permitAll()
                                .antMatchers("/api/v1/count/schoolmate").hasRole(Role.USER.getName())
                                .antMatchers("/api/v1/count/our/schoolguestbook").hasRole(Role.USER.getName())
                                ...
                                .antMatchers("/api/v1/schoolGuestBook/**").hasRole(Role.USER.getName())
